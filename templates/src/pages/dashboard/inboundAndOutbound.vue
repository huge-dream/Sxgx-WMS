      ...
      >
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td key="mode_code" :props="props">{{
              props.row.mode_code
            }}</q-td>
  ...
  data() {
    return {
      ...
      columns: [
        {
          name: "goods_code",
          label: this.$t("dashboards.view_tradelist.goods_code"),
          field: "goods_code",
          align: "left",
        },
        {
          name: "bin_name",
          label: this.$t("dashboards.view_tradelist.bin_name"),
          field: "bin_name",
          align: "center",
        },
        {
        ...
        },
        {
          name: "mode_code",
          required: true,
          label: this.$t("dashboards.view_tradelist.mode_code"),
          align: "center",
          field: "mode_code",
        },
        {
          name: "goods_qty",
          label: this.$t("dashboards.view_tradelist.goods_qty"),
          field: "goods_qty",
          align: "center",
        },
        {
          name: "creater",
          label: this.$t("dashboards.view_tradelist.creater"),
          field: "creater",
          align: "center",
        },
        {
          name: "create_time",
          label: this.$t("dashboards.view_tradelist.create_time"),
          field: "create_time",
          align: "center",
        },
        {
          name: "update_time",
          label: this.$t("dashboards.view_tradelist.update_time"),
          field: "update_time",
          align: "right",
        },
      ],
