...
export default {
      ...
      columns: [
        {
          name: "warehouse_name",
          required: true,
          label: this.$t("warehouse.view_warehouse.warehouse_name"),
          align: "left",
          field: "warehouse_name",
        },
        {
          name: "warehouse_city",
          label: this.$t("warehouse.view_warehouse.warehouse_city"),
          field: "warehouse_city",
          align: "center",
        },
        {
          name: "warehouse_address",
          label: this.$t("warehouse.view_warehouse.warehouse_address"),
  ...
  methods: {
    ...
    newDataSubmit() {
      ...
      if (
        warehousesets.indexOf(_this.newFormData.warehouse_name) === -1 &&
        _this.newFormData.warehouse_name.length !== 0
      ) {
