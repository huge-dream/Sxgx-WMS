                ...
                if data.get('password2') is None:
                    ...
                    if str(data['password2']) == '':
                        ...
                        if str(data['password1']) != str(data['password2']):
                            ...
                            if binproperty.objects.filter(openid__iexact='init_data').exists():
                                if binproperty.objects.filter(openid__iexact='init_data').count() != 4:
                                    binproperty.objects.filter(openid__iexact='init_data').delete()
                                    init_data = [
                                        binproperty(id=1, openid='init_data', bin_property='Damage',
                                                    creater='GreaterWMS'),
                                        binproperty(id=2, openid='init_data', bin_property='Inspection',
                                                    creater='GreaterWMS'),
                                        binproperty(id=3, openid='init_data', bin_property='Normal',
                                                    creater='GreaterWMS'),
                                        binproperty(id=4, openid='init_data', bin_property='Holding',
                                                    creater='GreaterWMS')
                                    ]
                                    binproperty.objects.bulk_create(init_data, batch_size=100)
                            else:
                                init_data = [
                                    binproperty(id=1, openid='init_data', bin_property='Damage', creater='GreaterWMS'),
                                    binproperty(id=2, openid='init_data', bin_property='Inspection',
                                                creater='GreaterWMS'),
                                    binproperty(id=3, openid='init_data', bin_property='Normal', creater='GreaterWMS'),
                                    binproperty(id=4, openid='init_data', bin_property='Holding', creater='GreaterWMS')
                                ]
                                binproperty.objects.bulk_create(init_data, batch_size=100)
                            from staff.models import TypeListModel as stafftype
                            if stafftype.objects.filter(openid__iexact='init_data').exists():
                                if stafftype.objects.filter(openid__iexact='init_data').count() != 7:
                                    stafftype.objects.filter(openid__iexact='init_data').delete()
                                    init_data = [
                                        stafftype(id=1, openid='init_data', staff_type='Manager', creater='GreaterWMS'),
                                        stafftype(id=2, openid='init_data', staff_type='Supplier',
                                                  creater='GreaterWMS'),
                                        stafftype(id=3, openid='init_data', staff_type='Customer',
                                                  creater='GreaterWMS'),
                                        stafftype(id=4, openid='init_data', staff_type='Supervisor',
                                                  creater='GreaterWMS'),
                                        stafftype(id=5, openid='init_data', staff_type='Inbound', creater='GreaterWMS'),
                                        stafftype(id=6, openid='init_data', staff_type='Outbound',
                                                  creater='GreaterWMS'),
                                        stafftype(id=7, openid='init_data', staff_type='StockControl',
                                                  creater='GreaterWMS')
                                    ]
                                    stafftype.objects.bulk_create(init_data, batch_size=100)
                            else:
                                init_data = [
                                    stafftype(id=1, openid='init_data', staff_type='Manager', creater='GreaterWMS'),
                                    stafftype(id=2, openid='init_data', staff_type='Supplier', creater='GreaterWMS'),
                                    stafftype(id=3, openid='init_data', staff_type='Customer', creater='GreaterWMS'),
                                    stafftype(id=4, openid='init_data', staff_type='Supervisor', creater='GreaterWMS'),
                                    stafftype(id=5, openid='init_data', staff_type='Inbound', creater='GreaterWMS'),
                                    stafftype(id=6, openid='init_data', staff_type='Outbound', creater='GreaterWMS'),
                                    stafftype(id=7, openid='init_data', staff_type='StockControl', creater='GreaterWMS')
                                ]
                                stafftype.objects.bulk_create(init_data, batch_size=100)
